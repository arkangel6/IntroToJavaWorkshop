...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("sound3.wav"));
	...
	private void showScaryImage(String a) {
		try {
			maze = ImageIO.read(getClass().getResource(a));
		} catch (Exception e) {
			System.err.println("Couldn't find this image: " + a);
		}
		repaint();
	}
